...
| Date | Jetpack Version | SoM | Image Version | Kernel version | Release note | Default ship version |
| :---- | :---- | :---- | :---- | :---- | :---- | :---- |
| 2026-07-09 | 6.2.2 | AGX Orin 32G/64G | 4.3.1.2 | 5.15.185-tegra | 1. Disabled automatic updates to prevent associated system errors. <br> 2. Updated Realtek Wi-Fi module and firmware to improve Access Point (AP) mode stability. <br> 3. Supported VIOB-AE10M module. <br> 4. Supported ORBBEC Gemini 335Lg camera. | |
