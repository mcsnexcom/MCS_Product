...
sudo PACKAGE_NAME=ATC3540_mfi_${VERSION} \
    BOARDID=3767 FAB=300 BOARDSKU=0001 BOARDREV=M.3 CHIP_SKU="00:00:00:D4" \
...
#offline mode
sudo PACKAGE_NAME=ATC3540_mfi_${VERSION} \
    BOARDID=3767 FAB=300 BOARDSKU=0000 BOARDREV=L.2 CHIP_SKU="00:00:00:D3" \
    ./tools/kernel_flash/l4t_initrd_flash.sh --no-flash --external-device nvme0n1p1 \
    -p "-c bootloader/generic/cfg/flash_t234_qspi.xml --no-systemimg" \
    -c tools/kernel_flash/flash_l4t_t234_nvme.xml \
    --massflash 5 --showlogs --network usb0 \
