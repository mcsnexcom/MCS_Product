...
**Functions:**
  - Hardware Communication:
    It directly communicates with the sensor using a specific I2C device file (ATC3530 defaults to /dev/i2c-8 ; ATC3540 defaults to /dev/i2c-7 ; ATC3750 defaults to /dev/i2c-0) and the sensor's I2C address (0x6B).
  - Initialization: 
