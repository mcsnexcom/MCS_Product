...
### 2. Open terminal and enter root mode and unzip file.
    $ sudo su
    $ tar xvf SPItoCAN_v1.3.tar.gz or tar xvf SPItoCAN_kernel_6.8.tar.gz
### 3. Enter folder SPItoCAN_v1.3 or SPItoCAN_kernel_6.8/mcp251xfd_MCS then Execute #apt-get update to updatepackages.
    $ apt-get update
### 4. Install packages
